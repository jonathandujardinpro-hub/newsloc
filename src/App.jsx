...
const CAR_BRANDS = {
  Lamborghini:   { models: ["Urus", "Urus Mansory", "STO", "Huracán Tecnica", "Revuelto"], color: "#B8952A" },
  Mercedes:      { models: ["G 63 AMG", "GT 63", "A 45 AMG", "G-Brabus"], color: "#7A9EBF" },
  Ferrari:       { models: ["F8 Tributo", "Roma", "Purosangue", "296 GTB", "296 GTS", "812 GTS", "SF90 Stradale"], color: "#CC3333" },
  Porsche:       { models: ["911", "911 GTS", "GT3", "GT3 RS"], color: "#2E7D52" },
  "Rolls-Royce": { models: ["Cullinan", "Phantom", "Spectre"], color: "#7B5EA7" },
